...
# Past Exam Question - 2022, Section B, Question 1

Answer the question on paper, then we will go through the answers from the examiner's report.
...
Students needed to explain why cleansing is a necessary process. To gain full marks, students needed to mention removing incomplete, inaccurate or irrelevant data as well as explain why this is an important process to complete.
Data cleansing is the process of identifying and correcting errors within a dataset, such as incomplete, inaccurate or irrelevant data points. This is an important aspect of data manipulation and analysis because it helps to ensure that data can be summarised and analysed accurately
...
- Removing blank spaces - This type of cleansing removes extra spaces within text that could affect readability.
    - Example: Removing extra spaces between words in a cell, such as between first name and last name, or between the street number and street name in an address.
- Editing text to upper or lower case - This type of cleansing improves the readability of text by having the correct case for letters in words.
    - Example: Ensuring the first letter of the first name, last name, or address is uppercase and all other letters are lowercase.
- Spell check - This type of cleansing ensures the correct spelling of names, events, and places.
    - Example: Spell checking to ensure events have the correct spelling, such as "Long Jump" or "High Jump".
- Find and replace - This type of cleansing is a way to find all examples of a word or number and replace them with another word or number. It is an efficient way of editing data.
    - Example: If an athlete's name was entered incorrectly, find and replace would enable the original spelling to be corrected in all instances it was found.
