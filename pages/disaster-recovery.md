...
- Strong disaster recovery plans are a key part of compliance with each of the privacy and data protection laws we covered. Failure to have a disaster recovery plan would representa failure to take "reasonable steps" to protect data.
...
A small business experiences a fire in its office building, causing damage to computers and loss of access to important data. 
